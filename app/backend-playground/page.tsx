...
export default async function Playground2() {
  try {
    ...
    const rec = await handleRecommendation("top", "female", "gpt-4o-mini", user_id, 3, 10, top_url);
    console.log("backend: ", rec);
    ...
    // console.log(result);
    // const labelString = await getLabelStringForImageSearch(undefined, "gpt-4o-mini", top_url);
